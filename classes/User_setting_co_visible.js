...
Model.prototype.mergeVisible = function (obj, cb) {
    if (arguments.length === 1) {
        cb = arguments[0];
        obj = {};
    }
    ...
    let user_id = obj.user_id,
        ...
        visible_data = obj.visible_data.length > 0 ? JSON.parse(obj.visible_data) : 'EMPTY',
        storedVisible,
        filtersToRemove,
        filtersToAdd,
        filtersToModify;
    ...
    async.series({
        ...
        getSettings: function(cb){
            ...
            _t.api(o, function(err,res){
                ...
                if(err) return cb(new MyError('Не удалось получить user_setting_co_visible', {o:o}))
        ...
        removeStoredVisible: function(cb){

            async.eachSeries(storedVisible, function(item,cb){
                ...
                _t.api(o, function(err,res){
                    if(err) return cb(new MyError('Не удалось удалить запись user_setting_co_visible', {o:o}))
        ...
        addFiltersFromClient: function(cb){
            ...
            async.eachSeries(visible_data, function(item,cb){
