...
(function (factory) {
	...
	if (typeof define === 'function' && define.amd) {
		define('jstree.node_customize', ['jquery','public_src/assets/js/plugins/jstree/src/jstree'], factory);
	}
	else if(typeof exports === 'object') {
		factory(require('jquery'), require('public_src/assets/js/plugins/jstree/src/jstree'));
	}
	else {
...
(function (factory) {
        "use strict";
        if (typeof define === 'function' && define.amd) {
                define('jstree.parentsload', ['jquery','public_src/assets/js/plugins/jstree/src/jstree'], factory);
        }
        else if(typeof exports === 'object') {
                factory(require('jquery'), require('public_src/assets/js/plugins/jstree/src/jstree'));
        }
